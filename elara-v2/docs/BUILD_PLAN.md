...
| 8 | Voice | VAD / wake-word / STT / TTS interfaces, energy VAD, transcript quality gate, espeak-ng TTS, faster-whisper adapter | done (interfaces + adapters; no mic capture loop yet) |
